...
############## PROPERTIES #######################
go = Property.create(name: 'Go', player: the_bank, url: "../monopoly-frontend/src/images/1.png")
...
jail = Property.create(name: 'Jail', player: the_bank, url: "../monopoly-frontend/src/images/11.png" )
...
electric_company = Property.create(name: 'Electric Company', set: 'Utility', price: 150, mortgage_val: 75, player: the_bank, url: "../monopoly-frontend/src/images/13.png" )
...
free_parking = Property.create(name: 'Free Parking', player: the_bank, url: "../monopoly-frontend/src/images/21.png" )
...
water_works = Property.create(name: 'Water Works', set: 'Utility', price: 150, mortgage_val: 75, player: the_bank, url: "../monopoly-frontend/src/images/29.png" )
...
go_to_jail = Property.create(name: 'Go To Jail', player: the_bank, url: "../monopoly-frontend/src/images/31.png" )
